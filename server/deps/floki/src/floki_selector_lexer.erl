-file("/home/default/.asdf/installs/erlang/27.2.4/lib/parsetools-2.6/include/leexinc.hrl", 0).
...
-file("/home/default/.asdf/installs/erlang/27.2.4/lib/parsetools-2.6/include/leexinc.hrl", 14).
...
yystate(69, [126|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(69, [94|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(41, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(69, [93|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(33, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(69, [92|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(71, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(69, [91|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(33, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(69, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(30, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(69, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(30, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(69, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 97, C =< 122 ->
    yystate(30, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(69, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 127 ->
    yystate(71, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(67, [126|Ics], Line, Col, Tlen, _, _) ->
    yystate(57, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(67, [124|Ics], Line, Col, Tlen, _, _) ->
    yystate(45, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(67, [62|Ics], Line, Col, Tlen, _, _) ->
    yystate(51, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(67, [44|Ics], Line, Col, Tlen, _, _) ->
    yystate(55, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(67, [43|Ics], Line, Col, Tlen, _, _) ->
    yystate(59, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(67, [41|Ics], Line, Col, Tlen, _, _) ->
    yystate(63, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(67, [32|Ics], Line, Col, Tlen, _, _) ->
    yystate(67, Ics, Line, Col, Tlen+1, 25, Tlen);
...
yystate(67, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(67, Ics, Line+1, 1, Tlen+1, 25, Tlen);
yystate(67, Ics, Line, Col, Tlen, _, _) ->
    {25,Tlen,Ics,Line,Col,67};
yystate(66, Ics, Line, Col, Tlen, _, _) ->
    {9,Tlen,Ics,Line,Col};
yystate(65, [61|Ics], Line, Col, Tlen, _, _) ->
    yystate(61, Ics, Line, Col, Tlen+1, 23, Tlen);
yystate(65, [32|Ics], Line, Col, Tlen, _, _) ->
    yystate(57, Ics, Line, Col, Tlen+1, 23, Tlen);
yystate(65, [12|Ics], Line, Col, Tlen, _, _) ->
    yystate(57, Ics, Line, Col, Tlen+1, 23, Tlen);
yystate(65, [13|Ics], Line, Col, Tlen, _, _) ->
    yystate(57, Ics, Line, Col, Tlen+1, 23, Tlen);
yystate(65, [9|Ics], Line, Col, Tlen, _, _) ->
    yystate(57, Ics, Line, Col, Tlen+1, 23, Tlen);
yystate(65, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(57, Ics, Line+1, 1, Tlen+1, 23, Tlen);
yystate(65, Ics, Line, Col, Tlen, _, _) ->
    {23,Tlen,Ics,Line,Col,65};
yystate(64, Ics, Line, Col, Tlen, _, _) ->
    {10,Tlen,Ics,Line,Col};
yystate(63, Ics, Line, Col, Tlen, _, _) ->
    {13,Tlen,Ics,Line,Col};
yystate(62, [41|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(60, [41|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(59, [32|Ics], Line, Col, Tlen, _, _) ->
    yystate(59, Ics, Line, Col, Tlen+1, 22, Tlen);
...
yystate(59, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(59, Ics, Line+1, 1, Tlen+1, 22, Tlen);
yystate(59, Ics, Line, Col, Tlen, _, _) ->
    {22,Tlen,Ics,Line,Col,59};
yystate(58, [100|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(57, Ics, Line, Col, Tlen, _, _) ->
    {23,Tlen,Ics,Line,Col,57};
yystate(56, [110|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(55, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(55, Ics, Line+1, 1, Tlen+1, 20, Tlen);
...
yystate(54, Ics, Line, Col, Tlen, _, _) ->
    {26,Tlen,Ics,Line,Col,54};
yystate(53, [61|Ics], Line, Col, Tlen, _, _) ->
    yystate(49, Ics, Line, Col, Tlen+1, 24, Tlen);
...
yystate(48, [100|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(58, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(48, [68|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(58, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(46, [61|Ics], Line, Col, Tlen, _, _) ->
    yystate(50, Ics, Line, Col, Tlen+1, 3, Tlen);
yystate(46, Ics, Line, Col, Tlen, _, _) ->
    {3,Tlen,Ics,Line,Col,46};
yystate(45, [32|Ics], Line, Col, Tlen, _, _) ->
    yystate(45, Ics, Line, Col, Tlen+1, 24, Tlen);
yystate(45, [12|Ics], Line, Col, Tlen, _, _) ->
    yystate(45, Ics, Line, Col, Tlen+1, 24, Tlen);
yystate(45, [13|Ics], Line, Col, Tlen, _, _) ->
    yystate(45, Ics, Line, Col, Tlen+1, 24, Tlen);
yystate(45, [9|Ics], Line, Col, Tlen, _, _) ->
    yystate(45, Ics, Line, Col, Tlen+1, 24, Tlen);
yystate(45, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(45, Ics, Line+1, 1, Tlen+1, 24, Tlen);
yystate(45, Ics, Line, Col, Tlen, _, _) ->
    {24,Tlen,Ics,Line,Col,45};
...
yystate(43, [93|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(42, [92|Ics], Line, Col, Tlen, _, _) ->
    yystate(34, Ics, Line, Col, Tlen+1, 0, Tlen);
...
yystate(41, Ics, Line, Col, Tlen, _, _) ->
    {26,Tlen,Ics,Line,Col,41};
yystate(40, [118|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(52, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(40, [86|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(52, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(40, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,40};
yystate(39, [126|Ics], Line, Col, Tlen, _, _) ->
    yystate(57, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(39, [124|Ics], Line, Col, Tlen, _, _) ->
    yystate(45, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(39, [115|Ics], Line, Col, Tlen, _, _) ->
    yystate(43, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(39, [105|Ics], Line, Col, Tlen, _, _) ->
    yystate(43, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(39, [62|Ics], Line, Col, Tlen, _, _) ->
    yystate(51, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(39, [44|Ics], Line, Col, Tlen, _, _) ->
    yystate(55, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(39, [43|Ics], Line, Col, Tlen, _, _) ->
    yystate(59, Ics, Line, Col, Tlen+1, 25, Tlen);
yystate(39, [41|Ics], Line, Col, Tlen, _, _) ->
    yystate(63, Ics, Line, Col, Tlen+1, 25, Tlen);
...
yystate(39, Ics, Line, Col, Tlen, _, _) ->
    {25,Tlen,Ics,Line,Col,39};
yystate(38, [95|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(42, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(38, [45|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(42, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(38, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(42, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(38, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(42, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(38, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 97, C =< 122 ->
    yystate(42, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(36, [110|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(44, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(36, [78|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(44, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(36, [41|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(34, [46|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(38, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(30, [92|Ics], Line, Col, Tlen, _, _) ->
    yystate(34, Ics, Line, Col, Tlen+1, 0, Tlen);
...
yystate(28, [110|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(44, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(28, [78|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(44, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(27, [34|Ics], Line, Col, Tlen, _, _) ->
    yystate(31, Ics, Line, Col, Tlen+1, 26, Tlen);
yystate(27, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(35, Ics, Line+1, 1, Tlen+1, 26, Tlen);
yystate(27, [C|Ics], Line, Col, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(35, Ics, Line, Col, Tlen+1, 26, Tlen);
yystate(27, [C|Ics], Line, Col, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(35, Ics, Line, Col, Tlen+1, 26, Tlen);
yystate(27, [C|Ics], Line, Col, Tlen, _, _) when C >= 35 ->
    yystate(35, Ics, Line, Col, Tlen+1, 26, Tlen);
...
yystate(26, [92|Ics], Line, Col, Tlen, _, _) ->
    yystate(18, Ics, Line, Col, Tlen+1, 5, Tlen);
...
yystate(25, [C|Ics], Line, Col, Tlen, _, _) when C >= 79, C =< 90 ->
    yystate(6, Ics, Line, Col, Tlen+1, 26, Tlen);
yystate(25, [C|Ics], Line, Col, Tlen, _, _) when C >= 97, C =< 109 ->
    yystate(6, Ics, Line, Col, Tlen+1, 26, Tlen);
yystate(25, [C|Ics], Line, Col, Tlen, _, _) when C >= 111, C =< 122 ->
    yystate(6, Ics, Line, Col, Tlen+1, 26, Tlen);
yystate(25, Ics, Line, Col, Tlen, _, _) ->
    {26,Tlen,Ics,Line,Col,25};
...
yystate(22, [95|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(21, [111|Ics], Line, Col, Tlen, _, _) ->
    yystate(17, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(21, [95|Ics], Line, Col, Tlen, _, _) ->
    yystate(6, Ics, Line, Col, Tlen+1, 7, Tlen);
...
yystate(21, [C|Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(6, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(21, [C|Ics], Line, Col, Tlen, _, _) when C >= 65, C =< 78 ->
    yystate(6, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(21, [C|Ics], Line, Col, Tlen, _, _) when C >= 80, C =< 90 ->
    yystate(6, Ics, Line, Col, Tlen+1, 7, Tlen);
...
yystate(18, [58|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(17, [92|Ics], Line, Col, Tlen, _, _) ->
    yystate(5, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(17, [84|Ics], Line, Col, Tlen, _, _) ->
    yystate(13, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(17, [45|Ics], Line, Col, Tlen, _, _) ->
    yystate(6, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(17, [C|Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(6, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(17, [C|Ics], Line, Col, Tlen, _, _) when C >= 65, C =< 83 ->
    yystate(6, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(17, [C|Ics], Line, Col, Tlen, _, _) when C >= 85, C =< 90 ->
    yystate(6, Ics, Line, Col, Tlen+1, 7, Tlen);
...
yystate(15, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(19, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(15, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(19, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(15, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 97, C =< 122 ->
    yystate(19, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(15, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,15};
yystate(14, [95|Ics], Line, Col, Tlen, _, _) ->
    yystate(14, Ics, Line, Col, Tlen+1, 5, Tlen);
...
yystate(14, Ics, Line, Col, Tlen, _, _) ->
    {5,Tlen,Ics,Line,Col,14};
yystate(13, [95|Ics], Line, Col, Tlen, _, _) ->
    yystate(6, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(13, [92|Ics], Line, Col, Tlen, _, _) ->
    yystate(5, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(13, [45|Ics], Line, Col, Tlen, _, _) ->
    yystate(6, Ics, Line, Col, Tlen+1, 7, Tlen);
yystate(13, [40|Ics], Line, Col, Tlen, _, _) ->
...
yystate(12, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(12, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 35 ->
    yystate(12, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(12, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,12};
yystate(11, [58|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(8, [10|Ics], Line, _, Tlen, _, _) ->
    yystate(4, Ics, Line+1, 1, Tlen+1, 26, Tlen);
yystate(8, [C|Ics], Line, Col, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(4, Ics, Line, Col, Tlen+1, 26, Tlen);
yystate(8, [C|Ics], Line, Col, Tlen, _, _) when C >= 11, C =< 38 ->
    yystate(4, Ics, Line, Col, Tlen+1, 26, Tlen);
yystate(8, [C|Ics], Line, Col, Tlen, _, _) when C >= 40 ->
    yystate(4, Ics, Line, Col, Tlen+1, 26, Tlen);
...
yystate(5, [58|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(1, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(5, [46|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(1, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(4, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11, C =< 38 ->
    yystate(4, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(4, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 40 ->
    yystate(4, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(1, [95|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(1, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(2, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(2, Ics, Line, Col, Tlen+1, Action, Alen);
...
-file("/home/default/.asdf/installs/erlang/27.2.4/lib/parsetools-2.6/include/leexinc.hrl", 344).
